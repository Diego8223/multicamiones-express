            ...
            <div className="footer-col footer-about">
              ...
              <div className="footer-socials">
                ...
                <div className="social-links">
                  <a href="https://facebook.com/MulticamionesExpress" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="social-link facebook">
                    <FaFacebookF />
                  </a>
                  <a href="https://instagram.com/MulticamionesExpress" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-link instagram">
                    <FaInstagram />
                  </a>
                  <a href="https://tiktok.com/@MulticamionesExpress" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="social-link tiktok">
                    <FaTiktok />
                  </a>
                </div>
              </div>
            ...
            <div className="footer-col footer-contact">
              ...
              <ul className="contact-info">
                ...
                <li className="contact-item">
                  ...
                  <a href="tel:+573015010196" className="contact-link">+57 301 501 0196</a>
                </li>
                <li className="contact-item">
                  <FaEnvelope className="contact-icon" />
                  <a href="mailto:info@multicamionesexpress.com" className="contact-link">info@multicamionesexpress.com</a>
                </li>
              </ul>
            </div>
          </div>
